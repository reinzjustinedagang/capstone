...
SELECT 
  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 60 AND 65 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "60_65",
    
  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 66 AND 70 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "66_70",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 71 AND 75 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "71_75",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 76 AND 80 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "76_80",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 81 AND 85 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "81_85",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 86 AND 90 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "86_90",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 91 AND 95 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "91_95",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) BETWEEN 96 AND 100 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "96_100",

  CAST(SUM(CASE 
    WHEN CAST(JSON_UNQUOTE(JSON_EXTRACT(form_data, '$.age')) AS UNSIGNED) >= 101 
    THEN 1 ELSE 0 END) AS UNSIGNED) AS "100_plus"
