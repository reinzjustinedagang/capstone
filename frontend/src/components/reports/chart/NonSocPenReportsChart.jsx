    ...
    const fetchReports = async () => {
      try {
        ...
        const res = await axios.get(
          `${backendUrl}/api/charts/non-socpen?year=${year}`
        );
        setReports(res.data || []);
      } catch (err) {
        console.error("Error fetching Non-SocPen reports:", err);
      } finally {
        setLoading(false);
      }
    };
...
export default NonSocPenReportsChart;
